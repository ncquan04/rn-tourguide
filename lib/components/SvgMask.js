...
export class SvgMask extends Component {
    ...
    render() {
        ...
        return (React.createElement(Pressable, { style: this.props.style, onLayout: this.handleLayout, pointerEvents: dismissOnPress ? undefined : 'none', onPress: dismissOnPress ? stop : undefined },
