...
export class Modal extends React.Component {
    ...
    async _animateMove(obj = {
        ...
        const toValue = verticalPosition === 'bottom'
            ...
            : obj.top -
                MARGIN -
                135 -
                (((_a = this.props.currentStep) === null || _a === void 0 ? void 0 : _a.tooltipBottomOffset) || 0);
        ...
        if (toValue !== this.state.tooltipTranslateY._value &&
            !((_b = this.props.currentStep) === null || _b === void 0 ? void 0 : _b.keepTooltipPosition)) {
    ...
    renderTooltip() {
        ...
        return (React.createElement(Animated.View, { pointerEvents: 'box-none', key: 'tooltip', style: [
            ...
            React.createElement(TooltipComponent, { isFirstStep: this.state.isFirstStep, isLastStep: this.state.isLastStep, currentStep: this.state.currentStep, handleNext: this.handleNext, handlePrev: this.handlePrev, handleStop: this.handleStop, labels: this.props.labels, imgSrc: (_a = this.state.currentStep) === null || _a === void 0 ? void 0 : _a.imgSrc })));
    }
